...
export default function CreateAccount({
  ...
  return (
    <View style={tailwind("flex-1 mx-12 mt-16")}>
      ...
      <TouchableOpacity
        style={tailwind("absolute top-2 right-0")}
        onPress={handleDone}
      >
      ...
      <View style={tailwind("mt-6")}>
        <Text style={tailwind("mb-3 text-gray-700 ml-4")}>
          Confirm Password
        </Text>
        <TextInput
      ...
      <TouchableOpacity
        style={tailwind(
          "justify-center items-center rounded-3xl py-4 mt-12 bg-white w-full border border-gray-200",
        )}
      >
